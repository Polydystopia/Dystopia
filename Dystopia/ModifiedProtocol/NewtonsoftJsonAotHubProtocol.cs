...
{
    public class NewtonsoftJsonAotHubProtocol : IHubProtocol
    {
        ...
        private const string ProtocolName = "json_aot";
        ...
        /// </summary>
        public NewtonsoftJsonAotHubProtocol() : this(Options.Create(new NewtonsoftJsonAotHubProtocolOptions()))
        {
        }
        ...
        public NewtonsoftJsonAotHubProtocol(IOptions<NewtonsoftJsonAotHubProtocolOptions> options)
        {
