...
namespace Dystopia.Migrations
{
    ...
    [Migration("20250822071429_AddWeeklyChallengeEntryIndexes")]
    partial class AddWeeklyChallengeEntryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dystopia.Database.Highscore.HighscoreEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");

                    b.Property<int>("Tribe")
                        .HasColumnType("INTEGER");

                    b.Property<byte[]>("FinalGameStateData")
                        .HasColumnType("BLOB");
            ...
            modelBuilder.Entity("Dystopia.Database.TribeRating.TribeRatingEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("TribeRatings");
                });

            modelBuilder.Entity("Dystopia.Database.User.GameParticipatorUserUser", b =>
                {
            ...
            modelBuilder.Entity("Dystopia.Database.WeeklyChallenge.League.LeagueEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<float>("DemotionRate")
                        .HasColumnType("REAL");

                    b.Property<bool>("IsEntry")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("IsFriendsLeague")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<float>("PromotionRate")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("Dystopia.Database.WeeklyChallenge.WeeklyChallengeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Dystopia.Database.WeeklyChallenge.WeeklyChallengeEntryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Dystopia.Database.Game.GameEntity", b =>
                {
                    b.HasOne("Dystopia.Database.Lobby.LobbyEntity", "Lobby")
                        .WithOne("Game")
                        .HasForeignKey("Dystopia.Database.Game.GameEntity", "LobbyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Dystopia.Database.WeeklyChallenge.WeeklyChallengeEntryEntity", b =>
                {
                    b.HasOne("Dystopia.Database.Game.GameEntity", "Game")
                        .WithOne("WeeklyChallengeEntry")
                        .HasForeignKey("Dystopia.Database.WeeklyChallenge.WeeklyChallengeEntryEntity", "GameId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Dystopia.Database.WeeklyChallenge.League.LeagueEntity", "League")
                        .WithMany()
                    ...
                    b.HasOne("Dystopia.Database.User.UserEntity", "User")
                        .WithMany("WeeklyChallengeEntries")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Dystopia.Database.WeeklyChallenge.WeeklyChallengeEntity", "WeeklyChallenge")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("Dystopia.Database.Game.GameEntity", b =>
                {
                    ...
                    b.Navigation("WeeklyChallengeEntry");
                });
            ...
            modelBuilder.Entity("Dystopia.Database.User.UserEntity", b =>
                {
                    ...
                    b.Navigation("TribeRatings");

                    b.Navigation("WeeklyChallengeEntries");
                });
